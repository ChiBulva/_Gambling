def PlayGame():
    ...
    Games = InitilizeRandomGame(NumGames)
    #PrintGames(Games)

    Bets = InitilizeRandomBets(NumBets, Games)
    #PrintBets(Bets)
...
def InitilizeRandomBets(NumBets, Games):
...
def PrintGames(Games):
    ...
    for num in range(len(Games)):
        print("|   Game "+str(num+1)+": \n|\tTeam "+str(count)+": "+Games[num][0]+ "\t\tvs\t\tTeam "+str(count2)+": "+Games[num][1])
        count = count + 2
        count2 = count2 + 2
